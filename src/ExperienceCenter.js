  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Experience Center</h1>
          <p className="text-gray-600 mt-1">Try our AI agents with different scenarios and use cases</p>
        </div>
      </div>
