      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        {tab === "Engagement" && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mb-8">
              <MetricCard label="Accounts Reached" value="62,500" sublabel={"+8.5% from last month"} />
              <MetricCard label="Connectivity %" value="78.5%" sublabel={"+2.3% from last month"} />
              <MetricCard label="RPC Rate" value="42.1%" sublabel={"+1.5% from last month"} />
              <MetricCard label="PTP Rate" value="19.3%" sublabel={"+2.5% from last month"} />
              <MetricCard label="Resolution Rate" value="12.5%" sublabel={"+1.8% from last month"} />
              <MetricCard label="Collection Rate %" value="8.7%" sublabel={"+1.2% from last month"} />
            </div>

            {/* Engagement Rates Chart */}
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Engagement Rates</div>
              <div className="text-xs text-zinc-500 mb-4">Connectivity, RPC, PTP, and Resolution rates over time</div>
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={[
                  { date: "2023-10-01", connectivity: 78.5, rpc: 42.1, ptp: 19.3, resolution: 12.5 },
                  { date: "2023-10-02", connectivity: 78.7, rpc: 42.3, ptp: 19.4, resolution: 12.6 },
                  { date: "2023-10-03", connectivity: 78.9, rpc: 42.5, ptp: 19.5, resolution: 12.7 },
                  { date: "2023-10-04", connectivity: 79.0, rpc: 42.7, ptp: 19.6, resolution: 12.8 },
                  { date: "2023-10-05", connectivity: 79.2, rpc: 42.9, ptp: 19.7, resolution: 12.9 },
                  { date: "2023-10-06", connectivity: 79.3, rpc: 43.0, ptp: 19.8, resolution: 13.0 },
                  { date: "2023-10-07", connectivity: 79.5, rpc: 43.2, ptp: 19.9, resolution: 13.1 },
                ]} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="date" />
                  ...
                  <Tooltip formatter={(v) => v + "%"} />
                  <Legend />
                  <Line type="monotone" dataKey="connectivity" name="connectivity" stroke="#2563eb" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="rpc" name="rpc" stroke="#06b6d4" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="ptp" name="ptp" stroke="#f59e42" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="resolution" name="resolution" stroke="#22c55e" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Customer Engagement Funnel</div>
              <div className="text-xs text-zinc-500 mb-4">Conversion rates through the engagement process</div>
              <div className="flex flex-col gap-2">
                <div className="bg-blue-600 text-white font-semibold rounded-md px-4 py-2 w-full max-w-xl">Accounts Reached: 62,500</div>
                <div className="bg-blue-500 text-white font-semibold rounded-md px-4 py-2 w-11/12 max-w-lg">Connected: 49,063 (78.5%)</div>
                <div className="bg-blue-400 text-white font-semibold rounded-md px-4 py-2 w-9/12 max-w-md">Right Party Contact: 26,314 (42.1%)</div>
                <div className="bg-blue-300 text-white font-semibold rounded-md px-4 py-2 w-7/12 max-w-sm">Promise to Pay: 5,067 (19.3% of RPCs)</div>
                <div className="bg-blue-200 text-blue-900 font-semibold rounded-md px-4 py-2 w-6/12 max-w-xs">PTP Kept: 4,145 (15.8% of RPCs)</div>
                <div className="bg-blue-100 text-blue-900 font-semibold rounded-md px-4 py-2 w-5/12 max-w-xs">Resolution: 3,281 (12.5% of RPCs)</div>
              </div>
            </div>

            {/* Channel Performance Table */}
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Channel Performance</div>
              <div className="text-xs text-zinc-500 mb-4">Engagement metrics by communication channel</div>
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-separate border-spacing-y-2">
                  <thead>
                    <tr className="bg-zinc-50 text-zinc-700">
                  ...
                  <tbody>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Voice</td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">SMS</td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Email</td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">WhatsApp</td>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">Campaign Summary</div>
              <div className="text-xs text-zinc-500 mb-4">Overview of all collection campaigns</div>
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-separate border-spacing-y-2">
                  <thead>
                    <tr className="bg-zinc-50 text-zinc-700">
                  ...
                  <tbody>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Campaign 1<br /><span className="text-xs text-zinc-400">CAM-001</span></td>
                      <td className="px-4 py-2"><span className="inline-block bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs font-semibold">Active</span></td>
                      <td className="px-4 py-2">12,500</td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Campaign 2<br /><span className="text-xs text-zinc-400">CAM-002</span></td>
                      <td className="px-4 py-2"><span className="inline-block bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs font-semibold">Active</span></td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Campaign 3<br /><span className="text-xs text-zinc-400">CAM-003</span></td>
                      <td className="px-4 py-2"><span className="inline-block bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs font-semibold">Completed</span></td>
                      <td className="px-4 py-2">6,250</td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Campaign 4<br /><span className="text-xs text-zinc-400">CAM-004</span></td>
                      <td className="px-4 py-2"><span className="inline-block bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full text-xs font-semibold">Paused</span></td>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">Campaign 5<br /><span className="text-xs text-zinc-400">CAM-005</span></td>
                      <td className="px-4 py-2"><span className="inline-block bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs font-semibold">Active</span></td>
        ...
        {tab === "Compliance" && (
          <>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Compliance Rate</div>
              <div className="text-xs text-zinc-500 mb-4">Compliance rate over time</div>
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={[
                  ...
                  <YAxis domain={[0, 100]} tickFormatter={(v) => v + "%"} />
                  <Tooltip formatter={(v) => v + "%"} />
                  <Line type="monotone" dataKey="compliance" name="compliance" stroke="#2563eb" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            {/* Complaint Log Table */}
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">Complaint Log</div>
              <div className="text-xs text-zinc-500 mb-4">Detailed record of customer complaints</div>
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-separate border-spacing-y-2">
                  <thead>
                    <tr className="bg-zinc-50 text-zinc-700">
                  ...
                  <tbody>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">COMP-001</td>
                      ...
                      <td className="px-4 py-2">Customer complained about receiving too many calls in a short period.</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">COMP-002</td>
                      ...
                      <td className="px-4 py-2">Customer claims they have already paid the debt in question.</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">COMP-003</td>
                      <td className="px-4 py-2">Oct 22, 2023</td>
                      <td className="px-4 py-2">ACC-34567</td>
                      <td className="px-4 py-2">Email</td>
                      <td className="px-4 py-2">Payment Issues</td>
                      <td className="px-4 py-2">Customer unable to make payment through the provided link.</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">COMP-004</td>
                      <td className="px-4 py-2">Oct 20, 2023</td>
                      <td className="px-4 py-2">ACC-45678</td>
                      <td className="px-4 py-2">Voice</td>
                      <td className="px-4 py-2">Rude Agent/Bot</td>
                      <td className="px-4 py-2">Customer felt the bot was not understanding or was rude.</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">COMP-005</td>
                      <td className="px-4 py-2">Oct 18, 2023</td>
                      <td className="px-4 py-2">ACC-56789</td>
                      <td className="px-4 py-2">Voice</td>
                      <td className="px-4 py-2">Wrong Party Contact</td>
                      <td className="px-4 py-2">Person contacted claims they are not the debtor.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        {tab === "Voice" && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
                <div className="font-semibold text-zinc-900 mb-2">AHT and Containment Rate</div>
                <div className="text-xs text-zinc-500 mb-4">Average handle time and bot containment rate over time</div>
                <ResponsiveContainer width="100%" height={220}>
                  <LineChart data={[
                    ...
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="date" />
                    <YAxis yAxisId="left" domain={[0, 220]} tickFormatter={(v) => v + "s"} />
                    <YAxis yAxisId="right" orientation="right" domain={[0, 100]} tickFormatter={(v) => v + "%"} />
                    <Tooltip formatter={(v, n) => n === "aht" ? v + "s" : v + "%"} />
                    <Legend />
                    <Line yAxisId="left" type="monotone" dataKey="aht" name="AHT (seconds)" stroke="#6366f1" strokeWidth={2} dot={false} />
                    <Line yAxisId="right" type="monotone" dataKey="containment" name="Containment Rate" stroke="#22c55e" strokeWidth={2} dot={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 flex flex-col justify-between">
                <div>
                  <div className="font-semibold text-zinc-900 mb-2">Transfer Reasons</div>
                  <div className="text-xs text-zinc-500 mb-4">Reasons for transfers from bot to human agent</div>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-blue-500 inline-block"></span>
                    <span className="text-sm text-zinc-700 flex-1">Complex Question: 35%</span>
                    <span className="text-xs text-zinc-400">35</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-green-500 inline-block"></span>
                    <span className="text-sm text-zinc-700 flex-1">Payment Arrangement: 28%</span>
                    <span className="text-xs text-zinc-400">28</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-yellow-400 inline-block"></span>
                    <span className="text-sm text-zinc-700 flex-1">Dispute: 22%</span>
                    <span className="text-xs text-zinc-400">22</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-red-500 inline-block"></span>
                    <span className="text-sm text-zinc-700 flex-1">Technical Issue: 15%</span>
                ...
                <div className="mt-4">
                  <div className="flex h-3 w-full rounded-full overflow-hidden bg-zinc-200">
                    ...
                    <div className="bg-yellow-400 h-full" style={{ width: "22%" }}></div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Voice Engagement Funnel</div>
              <div className="text-xs text-zinc-500 mb-4">Conversion rates through the voice engagement process</div>
              <div className="flex flex-col gap-2">
                <div className="bg-blue-600 text-white font-semibold rounded-md px-4 py-2 w-full max-w-2xl">Total Calls: 41,800</div>
                <div className="bg-blue-500 text-white font-semibold rounded-md px-4 py-2 w-11/12 max-w-xl">Connected: 28,633 (68.5%)</div>
                <div className="bg-blue-400 text-white font-semibold rounded-md px-4 py-2 w-9/12 max-w-lg">Right Party Contact: 18,894 (45.2% of total)</div>
                <div className="bg-blue-300 text-white font-semibold rounded-md px-4 py-2 w-7/12 max-w-md">Promise to Pay: 8,569 (20.5% of total)</div>
                <div className="bg-blue-200 text-blue-900 font-semibold rounded-md px-4 py-2 w-6/12 max-w-sm">PTP Kept: 7,022 (16.8% of total)</div>
                <div className="bg-blue-100 text-blue-900 font-semibold rounded-md px-4 py-2 w-5/12 max-w-xs">Resolution/Recovery: 5,225 (12.5% of total)</div>
              </div>
            </div>

            {/* Voice Bot Performance Chart */}
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">Voice Bot Performance</div>
              <div className="text-xs text-zinc-500 mb-4">Success, transfer, and abandon rates over time</div>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={[
                  { date: "2023-10-01", success: 74.2, transfer: 18.5, abandon: 7.3 },
                  { date: "2023-10-02", success: 74.5, transfer: 18.3, abandon: 7.2 },
                  { date: "2023-10-03", success: 74.8, transfer: 18.1, abandon: 7.1 },
                  { date: "2023-10-04", success: 75.0, transfer: 18.0, abandon: 7.0 },
                  { date: "2023-10-05", success: 75.2, transfer: 17.8, abandon: 7.0 },
                  { date: "2023-10-06", success: 75.5, transfer: 17.6, abandon: 6.9 },
                  { date: "2023-10-07", success: 75.7, transfer: 17.5, abandon: 6.8 },
                ]} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="date" />
                  <YAxis domain={[0, 100]} tickFormatter={(v) => v + "%"} />
                  ...
                  <Line type="monotone" dataKey="transfer" name="transfer" stroke="#2563eb" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="abandon" name="abandon" stroke="#ef4444" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </>
        ...
        {tab === "SMS" && (
          <>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">SMS Performance</div>
              <div className="text-xs text-zinc-500 mb-4">Delivery and response rates over time</div>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={[
                  ...
                  <Tooltip formatter={(v) => v + "%"} />
                  <Legend />
                  <Line type="monotone" dataKey="delivery" name="delivery" stroke="#2563eb" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="response" name="response" stroke="#22c55e" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">SMS Delivery Rate and CTR</div>
              <div className="text-xs text-zinc-500 mb-4">Delivery and click-through rates over time</div>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={[
                  ...
                  <Tooltip formatter={(v) => v + "%"} />
                  <Legend />
                  <Line type="monotone" dataKey="delivery" name="Delivery Rate" stroke="#22c55e" strokeWidth={2} dot={false} />
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">SMS Opt-out Rate</div>
              <div className="text-xs text-zinc-500 mb-4">Percentage of recipients who opted out over time</div>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={[
                  ...
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="date" />
                  <YAxis domain={[0, 1]} tickFormatter={(v) => (v * 100).toFixed(2) + "%"} />
                  <Tooltip formatter={(v) => (v * 100).toFixed(2) + "%"} />
                  <Legend />
                  <Line type="monotone" dataKey="optout" name="Opt-out Rate" stroke="#ef4444" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </>
        ...
        {tab === "Email" && (
          <>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Email Performance</div>
              <div className="text-xs text-zinc-500 mb-4">Delivery, open, and click rates over time</div>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={[
                  { date: "2023-10-01", delivery: 97.0, open: 42.3, click: 9.7 },
                  { date: "2023-10-02", delivery: 97.1, open: 42.4, click: 9.8 },
                  { date: "2023-10-03", delivery: 97.2, open: 42.5, click: 9.9 },
                  { date: "2023-10-04", delivery: 97.3, open: 42.6, click: 10.0 },
                  { date: "2023-10-05", delivery: 97.4, open: 42.7, click: 10.1 },
                  { date: "2023-10-06", delivery: 97.5, open: 42.8, click: 10.2 },
                  { date: "2023-10-07", delivery: 97.6, open: 42.9, click: 10.3 },
                ]} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="date" />
                  <YAxis domain={[0, 100]} tickFormatter={(v) => v + "%"} />
                  ...
                  <Legend />
                  <Line type="monotone" dataKey="delivery" name="delivery" stroke="#2563eb" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="open" name="open" stroke="#f59e42" strokeWidth={2} dot={false} />
                  <Line type="monotone" dataKey="click" name="click" stroke="#22c55e" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6 mb-8">
              <div className="font-semibold text-zinc-900 mb-2">Email Engagement Funnel</div>
              <div className="text-xs text-zinc-500 mb-4">Conversion through the email engagement process</div>
              <div className="flex flex-col gap-2">
                <div className="bg-blue-600 text-white font-semibold rounded-md px-4 py-2 w-full max-w-2xl">Sent: 43,500 (100%)</div>
                <div className="bg-blue-500 text-white font-semibold rounded-md px-4 py-2 w-11/12 max-w-xl">Delivered: 42,195 (97%)</div>
                <div className="bg-blue-400 text-white font-semibold rounded-md px-4 py-2 w-9/12 max-w-lg">Opened: 17,680 (42.3%)</div>
                <div className="bg-blue-300 text-white font-semibold rounded-md px-4 py-2 w-7/12 max-w-md">Clicked: 4,220 (10%)</div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">Email Engagement Map</div>
              <div className="text-xs text-zinc-500 mb-4">Geographical distribution of email engagement</div>
              <div className="flex flex-row gap-8 items-start">
                <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 text-sm min-w-[200px]">
                  <div className="font-semibold text-zinc-700 mb-2">Engagement by Region</div>
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-between"><span>North America</span><span>48.2%</span></div>
                    <div className="flex justify-between"><span>Europe</span><span>32.5%</span></div>
                    <div className="flex justify-between"><span>Asia Pacific</span><span>13.2%</span></div>
                    <div className="flex justify-between"><span>Latin America</span><span>4.3%</span></div>
                    <div className="flex justify-between"><span>Other</span><span>2.2%</span></div>
                  </div>
                </div>
                <div className="flex-1 flex items-center justify-center min-h-[180px] text-zinc-400 bg-zinc-100 rounded-lg border border-dashed border-zinc-200">
                  ...
                  <span className="text-xs">Geographic distribution of email engagement would appear here</span>
                </div>
              </div>
            </div>
          </>
        ...
        {tab === "Utilization" && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
                <div className="font-semibold text-zinc-900 mb-2">Voice Minutes Over Time</div>
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
                <div className="font-semibold text-zinc-900 mb-2">Voice Minutes by Type</div>
                <ResponsiveContainer width="100%" height={180}>
                  <BarChart data={[
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
                <div className="font-semibold text-zinc-900 mb-2">SMS Segments Sent Over Time</div>
                <ResponsiveContainer width="100%" height={180}>
                  <LineChart data={[
                    ...
                    <Tooltip formatter={(v) => v} />
                    <Line type="monotone" dataKey="segments" name="segments" stroke="#22c55e" strokeWidth={2} dot={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
              {/* Emails Sent Over Time */}
              <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
                <div className="font-semibold text-zinc-900 mb-2">Emails Sent Over Time</div>
                <ResponsiveContainer width="100%" height={180}>
                  <LineChart data={[
                    ...
                    <YAxis tickFormatter={(v) => v} />
                    <Tooltip formatter={(v) => v} />
                    <Line type="monotone" dataKey="emails" name="emails" stroke="#a78bfa" strokeWidth={2} dot={false} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-6">
              <div className="font-semibold text-zinc-900 mb-2">Channel Cost Analysis</div>
              <div className="text-xs text-zinc-500 mb-4">Cost breakdown by communication channel</div>
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-separate border-spacing-y-2">
                  <thead>
                    <tr className="bg-zinc-50 text-zinc-700">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-white">
                      <td className="px-4 py-2 font-medium text-zinc-900">API Calls</td>
